...
var Bot = new TwitterBot({
 ...
 function generateDish() {
    ...
    var adjs = ["fried", "refried", "southern", "original", "honey dijon", "unlimited", "chef's choice", "bottomless", "cheesy", "sloppy", "white cheddar", "Angus", "low-fat", "pumpkin cream", "All-American", "fit", "Santa Fe", "supreme", "sizzling", "bourbon", "buffalo", "cajun", "cali", "crispy", "ultimate", "deep dish", "homestyle", "classic", "southwest", "meat-lovers", "extra", "glazed", "garden", "harvest cheddar", "jalepeno", "sour cream and onion", "ranch", "tangy", "zesty", "cool ranch", "queso", "all beef", "$8", "$4", "barbecue ranch", "almond-crusted", "famous", "tex-mex", "deli-style"];
      var ingredients = ["bacon", "chicken", "cheese", "beef", "havarti", "fish", "white chocolate", "pork", "cinnamon roll", "pepperoni", "ham", "roast beef", "crayfish", "clam", "calamari", "iceberg lettuce", "tri-tip", "shrimp", "catfish"];
      var structures = ["patty", "melt", "patty melt", "pie", "gravy", "pancake", "pizza", "hot dog", "fingers", "rings", "slurpee", "sundae", "burger", "nuggets", "skins", "fillet", "sliders", "sampler", "platter", "steak", "doughnut", "waffle", "s'mores", "nachos", "poppers", "wedges", "bites", "scrambler", "meal", "chowder", "slam", "bowl", "combo", "sandwich", "salad", "po' boy"];
      var dish = "";
